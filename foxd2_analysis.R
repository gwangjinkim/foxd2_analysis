...
# rsync -avs "/home/josephus/Dropbox/a_myRNAseq/rdownstream/190122.rdownstream.central.R" josephus@132.230.165.153:/media/daten/arnold/josephus/script/
# rsync -avs "/media/josephus/Elements/metas" josephus@132.230.165.153:/media/daten/arnold/josephus/
...
#   if (i == 1) {
#     dataname <- "foxd2-mK3"
#     outdirpath <- "/media/josephus/Elements/DEanalysis/foxd2-mK3-201901"
#     metapath   <- "/media/josephus/Elements/metas/meta-foxd2-201901-mK3.txt"
#   }
#   
#   if (i == 2) {
#     dataname <- "foxd2-mK4"
#     outdirpath <- "/media/josephus/Elements/DEanalysis/foxd2-mK4-201901"
#     metapath   <- "/media/josephus/Elements/metas/meta-foxd2-201901-mK4.txt"
#   }
#   
#   if (i == 3) {
#     dataname <- "foxd2-overview"
#     outdirpath <- "/media/josephus/Elements/DEanalysis/foxd2-overview-201901"
#     metapath   <- "/media/josephus/Elements/metas/meta-foxd2-201901-overview.txt"
#   }
# 
#   ####################################################################
#   # get meta information
...
#                             dataname = dataname,
#                             printp = TRUE, normalized = TRUE, averaged = TRUE,
#                             sheetName = "avg.normalized.all") # now list with nrm-counts-avg and nrm-counts-sd
#   
#   #######################################################################
#   # Create DE table
#   #######################################################################
...
# overtook corrections from 190220.foxd2.analysis.further.txt
# without GO simplification!
...
#     mv dyn_15d_12345-vs-ift_15d_12345 ift_15d_12345-vs-dyn_15d_12345
#     tree ift_15d_12345-vs-dyn_15d_12345
#     for f in /media/josephus/Elements/DEanalysis/ift_15d_12345-vs-dyn_15d_12345/*/*/*; do
#       mv ${f} ${f/dyn_15d_12345_ift_15d_12345/ift_15d_12345_dyn_15d_12345}
#     done
#     for f in /media/josephus/Elements/DEanalysis/ift_15d_12345-vs-dyn_15d_12345/*/*/*/*; do
#       mv ${f} ${f/dyn_15d_12345_ift_15d_12345/ift_15d_12345_dyn_15d_12345}
#     done
  ...
  if (i == 9) {
    ...
    # mv /media/josephus/Elements/metas/meta-foxd2-201901-ift140ko-dft140ko-ud-15rm-4rm.txt \
    #    /media/josephus/Elements/metas/meta-foxd2-201901-ift140ko-dyn2h1ko-ud-15rm-4rm.txt # right
  }
...
#   for f in /media/josephus/Elements/DEanalysis/ift_15d_123-vs-dyn_15d_1234/*/*/*; do
#     mv ${f} ${f/ift_15d_123_dyn_15d_1234/ift_15d_1234_dyn_15d_123}
#   done
#   for f in /media/josephus/Elements/DEanalysis/ift_15d_1234-vs-dyn_15d_123/*/*/*/*; do
#     mv ${f} ${f/dyn_15d_1234_ift_15d_123/ift_15d_1234_dyn_15d_123}
#   done
#   mv /media/josephus/Elements/DEanalysis/ift_15d_123-vs-dyn_15d_1234 \
#      /media/josephus/Elements/DEanalysis/ift_15d_1234-vs-dyn_15d_123
#   tree /media/josephus/Elements/DEanalysis/ift_15d_1234-vs-dyn_15d_123
  if (i == 12) {
  ...
  if (i == 17) {
    ...
    # find . -depth -type d -name '(.*?)dyn_15d_123_ift_15d_123(.*?)' -exec rename 's/(.*?)dyn_15d_123_ift_15d_123(.*?)/$1ift_15d_123_dyn_15d_123$2/' {} +
    # right
#     for f in /media/josephus/Elements/DEanalysis/dyn_15d_123-vs-ift_15d_123_problematic/*/*/*; do
#       # echo ${f/dyn_15d_123_ift_15d_123/ift_15d_123_dyn_15d_123}
#       mv ${f} ${f/dyn_15d_123_ift_15d_123/ift_15d_123_dyn_15d_123}
#     done
#     for f in /media/josephus/Elements/DEanalysis/dyn_15d_123-vs-ift_15d_123_problematic/*/*/*/*; do
#       # echo ${f/dyn_15d_123_ift_15d_123/ift_15d_123_dyn_15d_123}
#       # echo ${f}
#       mv ${f} ${f/dyn_15d_123_ift_15d_123/ift_15d_123_dyn_15d_123}
#     done
#     mv /media/josephus/Elements/DEanalysis/dyn_15d_123-vs-ift_15d_123_problematic \
#        /media/josephus/Elements/DEanalysis/ift_15d_123-vs-dyn_15d_123
     # corrected!
     # tree /media/josephus/Elements/DEanalysis/ift_15d_123-vs-dyn_15d_123
     # nano  /media/josephus/Elements/DEanalysis/ift_15d_123-vs-dyn_15d_123/*/meta/meta*.txt
  }
...
rsync -rav -e "ssh -p 64168" josephus@132.230.165.168:/media/josephus/Elements/DEanalysis/foxd2-foxd2-F7-20200403 ~/Downloads/Elements/
